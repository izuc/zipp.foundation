module github.com/izuc/zipp.foundation/autopeering

go 1.20

require (
	github.com/izuc/zipp.foundation/crypto v0.0.0-20230417083738-41b63759a6b8
...
require (
	...
	github.com/izuc/zipp.foundation/serializer/v2 v2.0.0-rc.1.0.20230411094451-3a6bd8040e05 // indirect
